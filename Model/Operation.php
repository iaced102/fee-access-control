...
class Operation extends SqlObject
{
    ...
    public static $listAction = [
        'document_definition'   => ['name'=>'loại văn bản',         'ownerDomain' => 'document-management.symper.vn',   'action'=>['create','edit','submit','drop','restore','list','list_trash','list_instance','submit_by_workflow']],
        'document_instance'     => ['name'=>'văn bản',              'ownerDomain' => 'document-management.symper.vn',   'action'=>['update','delete','restore','detail','print','list_trash','update_by_workflow']],

...
class Operation extends SqlObject
{
    ...
    public static $listAction = [
        ...
        'document_instance'     => ['name'=>'văn bản',              'ownerDomain' => 'document-management.symper.vn',   'action'=>['update','delete','delete_multi','restore','detail','list_instance','print','print_multi','list_trash','update_by_workflow','clone','share_tree_config','share_filter','share_conditonal_format','invoice_issue', 'invoice_issue_in_process', 'invoice_adjust', 'invoice_adjust_in_process', 'invoice_replace', 'invoice_replace_in_process', 'invoice_cancel', 'invoice_cancel_in_process']],

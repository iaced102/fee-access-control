...
class Operation extends SqlObject
{
    ...
    public static $listAction = [
        ...
        'account'               => ['name'=>'người dùng',           'ownerDomain' => 'account.symper.vn',               'action'=>['create','update','restore','detail','change_pass', "delete",'list','set_role',"import", "export"]],
        ...
        'orgchart'              => ['name'=>'sơ đồ tổ chức',        'ownerDomain' => 'orgchart.symper.vn',              'action'=>['update','drop','list','detail','structure_management']],
